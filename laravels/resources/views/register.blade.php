...
<div class="wrapper">
    ...
    <div class="registerCon">
        <ul>
            <li class="accAndPwd">
                <dl>
                    <s class="phone"></s><input id="userMobile" name="tel" maxlength="11" type="number" placeholder="请输入您的手机号码" value="" />
                    <input id="usercode" type="text" style="width:50%" placeholder="请输入您的验证码" >
                    <button type="button" class="layui-btn"  id="dateBtn1">获取验证码</button>
                    <span class="clear">x</span>
                </dl>
                <dl>
                    <s class="password"></s>
                    <input class="pwd" maxlength="11" name="pwd"type="text" placeholder="6-16位数字、字母组成" value="" />
                    <input class="pwd" maxlength="11" name="pwd" type="password" placeholder="6-16位数字、字母组成" value="" style="display: none" />
                    <span class="mr clear">x</span>
                    <s class="eyeclose"></s>
                </dl>
                <dl>
                    <s class="password"></s>
                    <input class="conpwd" maxlength="11" name="pwds"type="text" placeholder="请确认密码" value="" />
                    <input class="conpwd" maxlength="11" name="pwds" type="password" placeholder="请确认密码" value="" style="display: none" />
                    <span class="mr clear">x</span>
                    <s class="eyeclose"></s>
                </dl>
