            ...
            <div class="menu-list-wrapper" id="divSortList">
                <ul id="sortListUl" class="list">
                    ...
                    <li sortid='100' reletype='1' linkaddr=''>
                        <span class='items list' show="{{$v->cate_id}}">{{$v->cate_name}}</span>
                    </li>
                        @endforeach
                </ul>
            </div>
            <div class="good-list-wrapper">
                <div class="good-menu thin-bor-bottom">
                    <ul class="good-menu-list" id="ulOrderBy">
                        ...
                        <li orderflag="30" class="add"><a href="javascript:;">价值</a><span class="i-wrap"><i class="up"></i><i class="down"></i></span></li>
                        <!--价值(由高到低30,由低到高31)-->
                    </ul>
                </div>
                                ...
                                <li id="23468">
                                    ...
                                    <div class="gList_r">
                                        <a href="/shopcontent?goods_id={{$v->goods_id}}">
                                            <h3 class="gray6">{{$v->goods_name}}</h3></a>
