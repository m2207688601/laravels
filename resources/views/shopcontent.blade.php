...
<meta name="csrf-token" content="{{ csrf_token() }}">
    <div class="page-group">
        ...
        @foreach ($data as $v)
                ...
                <!-- 产品信息 -->
                <div class="pro_info">
                    <h2 class="gray6" show="{{$v->goods_id}}">
                        {{$v->goods_name}}
                    </h2>
    ...
    <script>
        ...
        layui.use('layer',function(){
            ...
            $(".gray6").click(function(){
                layer.confirm("添加购物车",{title:'添加购物车'},function(index){
                    var url="cont";
                    var data={};
                    var id=$('.gray6').attr('show');
                    data.id=id;
                    // console.log(data.id)
                    $.ajax({
                        url:url,
                        ...
                        success:function(res){
                            ...
                            if(res.msg==1){
                                ...
                                layer.msg(res.font);
                                location.href='shopcart?goods_id='+id;
                            }
                        }
                    });
                });
